...
This checklist tracks non-code work needed before submitting DeskTrace to the Microsoft Store.

DeskTrace should continue to treat the Store release as an early public test until the product, privacy policy, packaging, and support flows are stable.
...
- [ ] State clearly that DeskTrace is in early public testing before `v1.0`.
...
- Current temporary official page: https://ys-bookcase.com/desktrace/
- Current temporary support page: https://ys-bookcase.com/desktrace/support/
- Current temporary privacy policy: https://ys-bookcase.com/desktrace/privacy-policy/
...
- [ ] Create an MSIX package for DeskTrace.
...
- [x] Publish the DeskTrace-specific privacy policy page.
...
- [ ] Explain that DeskTrace does not send usage records to a developer server by default.
- [ ] Explain that DeskTrace does not collect window titles, URLs, web page titles, document names, command lines, keystrokes, or screenshots by default.
...
- [ ] Build succeeds.
- [ ] Tests pass.
- [ ] Fresh install launches DeskTrace.
