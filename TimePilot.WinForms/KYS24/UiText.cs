...
namespace TimePilot.WinForms.KYS24
{
    internal static class UiText
    {
        ...
        public static string AppName => "ActiveLogbook";
        ...
        public static class Main
        {
            ...
            public static string DataRestoreInvalidBackup(string detail) =>
                current.Main.DataRestoreInvalidBackup(detail);
            ...
            public static string DataRestorePlan(bool hasSettings, int logCount, DateTimeOffset? createdAt) =>
                current.Main.DataRestorePlan(hasSettings, logCount, createdAt);
            ...
            public static UiTextResources CreateKorean()
            {
                return new UiTextResources(
                    ...
                    new MainText(
                        ...
                        IdleRecordedTimeTooltip: "마지막 입력 이후 설정한 유휴 기준 시간이 지난 뒤부터 ActiveLogbook이 유휴로 기록한 시간입니다. 읽기, 영상 시청, 대기, 자리 비움이 포함될 수 있습니다. 유휴 기준에 도달하기 전의 입력 없음 시간은 포함되지 않습니다.",
                        ActiveRatio: "활성 비중",
                        SwitchCount: "전환 횟수",
                        ...
                        Idle: "유휴",
                        Untracked: "미실행",
                        TimePilotUntracked: "ActiveLogbook 미실행",
                        Running: "실행 중",
                        Ended: "종료",
                        ...
                        DataBackupTitle: "ActiveLogbook 백업",
                        DataRestoreTitle: "ActiveLogbook 전체 복원",
                        DataBackupWarning: "백업 파일에는 사용 기록 데이터베이스와 설정이 포함됩니다. 개인 사용 기록이 들어 있으므로 보관과 공유에 주의하세요.\n\n백업을 만들까요?",
                        DataRestoreWarning: "현재 지원되는 방식은 전체 대체 복원입니다. 복원을 계속하면 현재 사용 기록 데이터베이스와 설정이 백업 파일의 내용으로 대체됩니다.\n\n복원 전에 현재 데이터를 안전 백업으로 저장할지 선택할 수 있습니다. 복원 후 ActiveLogbook은 현재 세션을 다시 시작합니다.",
                        DataRestoreMissingDatabase: "백업 파일에 timepilot.db가 없어 복원할 수 없습니다.",
                        DataRestoreInvalidBackup: detail => $"ActiveLogbook 백업 파일이 아니거나 백업 파일이 손상되었습니다.\n\n{detail}",
                        DataBackupReadmeTitle: "ActiveLogbook 백업",
                        DataBackupReadmeCreatedAt: createdAt => $"생성 시각: {createdAt}",
                        DataBackupReadmePrivacyNotice: "이 ZIP 파일에는 ActiveLogbook 사용 기록 데이터베이스와 설정이 포함되어 있습니다. 앱 이름, 프로세스 이름, 실행 경로, 사용 시간, 실행 기록 등 개인 사용 기록이 포함될 수 있으므로 공유와 보관에 주의하세요.",
                        DataBackupReadmeFileList: "포함 파일:",
                        RuntimeDiagnostics: "실행 진단",
                        Sponsor: "후원하기...",
                        SponsorAboutMessage: "ActiveLogbook 개발을 응원하고 싶다면 도움말 > 후원하기에서 GitHub Sponsors 페이지를 열 수 있습니다.",
                        SponsorOpened: "후원 페이지를 열었습니다.",
                        SponsorOpenFailed: message => $"후원 페이지를 열지 못했습니다.\n\n{message}",
                        RuntimeDiagnosticsTitle: "ActiveLogbook 실행 진단",
                        ...
                        SystemEventTimePilotStart: "ActiveLogbook 시작",
                        SystemEventTimePilotExit: "ActiveLogbook 종료",
                        AboutTitle: "ActiveLogbook 정보",
                        ...
                        StartupPromptTitle: "ActiveLogbook 자동 시작",
                        StartupPromptMessage: "Windows 시작 시 ActiveLogbook을 자동으로 실행할까요?\n\n나중에 환경 설정에서 언제든 변경할 수 있습니다.",
                        SafeModeTitle: "ActiveLogbook 안전모드",
                        ...
                        DuplicateInstanceMessage: "ActiveLogbook이 이미 실행 중입니다. 트레이 아이콘을 확인해 주세요.",
                        ...
                        DataRestorePlan: (hasSettings, logCount, createdAt) =>
                        ...
                        DataRestoreRestartingSession: "ActiveLogbook 기록 세션 다시 시작 중..."),
                    new CsvText(
                        Date: "날짜",
                        AppName: "앱 이름",
                        Category: "분류",
                    ...
                    new RawDataExportText(
                        ReadmeTitle: "ActiveLogbook 원본 데이터 내보내기",
                        ReadmePrivacyNotice: "이 ZIP 파일에는 기간 제한 없이 내보낸 전체 원본 데이터가 포함되어 있습니다. ActiveLogbook 내부 SQLite 테이블에 가까운 형태이며, 앱 이름, 프로세스 이름, 실행 파일 경로, 사용 시간, 실행 구간 등 개인 사용 기록이 포함될 수 있으므로 공유와 보관에 주의하세요.",
                    ...
                    new PreferencesText(
                        ...
                        ProcessRuntimeScopeHelpMessage:
                            ...
                            "모든 프로세스: ActiveLogbook이 접근 가능한 실행 중 프로세스 전체를 추적합니다. 시스템/서비스 프로세스가 일부 포함될 수 있고 성능 부담과 저장 데이터가 늘어날 수 있습니다.\n\n" +
                        ...
                        SponsorLink: "ActiveLogbook 개발 후원",
                        ...
                        AllProcessesScopeDescription: "ActiveLogbook이 접근 가능한 실행 중 프로세스 전체를 추적합니다. 시스템/서비스 프로세스가 일부 포함될 수 있고 성능 부담과 저장 데이터가 늘어날 수 있습니다.",
                        Custom: "사용자 지정",
                        AllProcessesRiskMessage: "모든 프로세스를 10초 미만 주기로 추적하면 환경에 따라 ActiveLogbook이 멈추거나 비정상 종료될 수 있습니다.\n\n같은 설정으로 짧은 실행 후 비정상 종료가 반복되면 다음 실행에서 백그라운드 앱 추적이 자동으로 꺼집니다.\n\n이 위험 설정을 저장하시겠습니까?",
            ...
            public static UiTextResources CreateEnglish()
            {
                return new UiTextResources(
                    ...
                    new MainText(
                        ...
                        RestoreDataBackup: "Full restore from backup...",
                        Exit: "Exit",
                        ...
                        IdleRecordedTimeTooltip: "ActiveLogbook records this time after no keyboard or mouse input has occurred for at least the configured idle threshold. It can include reading, watching video, waiting, or being away. Time before the idle threshold is reached is not included.",
                        ...
                        TimePilotUntracked: "ActiveLogbook not running",
                        Running: "Running",
                        Ended: "Ended",
                        ...
                        RawDataExportWarning: "Raw data can include app names, process names, executable paths, usage times, and runtime records.\n\nActiveLogbook currently exports all raw table CSV files without a date range limit into a ZIP file. Continue?",
                        DataBackupTitle: "ActiveLogbook backup",
                        DataRestoreTitle: "ActiveLogbook full restore",
                        ...
                        DataRestoreWarning: "The currently supported method is full replacement restore. If you continue, the current usage database and settings will be replaced with the backup contents.\n\nYou can choose whether to create a safety backup of the current data before restoring. ActiveLogbook will restart the current recording session after restore.",
                        DataRestoreMissingDatabase: "This backup cannot be restored because timepilot.db is missing.",
                        DataRestoreInvalidBackup: detail => $"This file is not a valid ActiveLogbook backup or the backup is damaged.\n\n{detail}",
                        DataBackupReadmeTitle: "ActiveLogbook backup",
                        DataBackupReadmeCreatedAt: createdAt => $"Created at: {createdAt}",
                        DataBackupReadmePrivacyNotice: "This ZIP file contains the ActiveLogbook usage database and settings. It can include personal usage records such as app names, process names, executable paths, usage times, and runtime records. Be careful when storing or sharing it.",
                        DataBackupReadmeFileList: "Included files:",
                        RuntimeDiagnostics: "Runtime diagnostics",
                        Sponsor: "Sponsor...",
                        SponsorAboutMessage: "To support ActiveLogbook development, open Help > Sponsor to visit the GitHub Sponsors page.",
                        SponsorOpened: "Opened the sponsor page.",
                        SponsorOpenFailed: message => $"Could not open the sponsor page.\n\n{message}",
                        RuntimeDiagnosticsTitle: "ActiveLogbook runtime diagnostics",
                        ...
                        SystemEventTimePilotStart: "ActiveLogbook start",
                        SystemEventTimePilotExit: "ActiveLogbook exit",
                        AboutTitle: "About ActiveLogbook",
                        ...
                        StartupPromptTitle: "ActiveLogbook startup",
                        StartupPromptMessage: "Run ActiveLogbook automatically when Windows starts?\n\nYou can change this later in Preferences.",
                        SafeModeTitle: "ActiveLogbook safe mode",
                        SafeModeMessage: "ActiveLogbook appears to have closed unexpectedly multiple times in a short period while risky background app tracking settings were enabled.\n\nSafe mode automatically disabled only background app tracking. Current app usage tracking and idle detection will continue to work.\n\nTo enable it again, go to Settings > Preferences and turn on background app tracking.",
                        SafeModeBalloonMessage: "Background app tracking was automatically disabled to avoid repeated unexpected exits.",
                        DuplicateInstanceMessage: "ActiveLogbook is already running. Check the tray icon.",
                        ...
                        DataRestoreRestartingSession: "Restarting ActiveLogbook recording session..."),
                    new CsvText(
                        Date: "Date",
                        AppName: "App name",
                        Category: "Category",
                    ...
                    new PreferencesText(
                        ...
                        ProcessRuntimeScopeHelpMessage:
                            ...
                            "All processes: Tracks all running processes ActiveLogbook can access. Some system or service processes can be included, and performance cost and stored data can increase.\n\n" +
                        ...
                        SponsorLink: "Sponsor ActiveLogbook development",
                        ...
                        AllProcessesScopeDescription: "Tracks all running processes ActiveLogbook can access. Some system or service processes can be included, and performance cost and stored data can increase.",
                        Custom: "Custom",
                        AllProcessesRiskMessage: "Tracking all processes at intervals shorter than 10 seconds may freeze or unexpectedly close ActiveLogbook depending on your environment.\n\nIf repeated unexpected exits happen shortly after launch with the same setting, background app tracking will be disabled on the next launch.\n\nSave this risky setting?",
                    ...
                    new RuntimeCoverageText(
                        ...
                        BootBeforeTimePilot: duration => $"Before ActiveLogbook after boot {duration}"));
            }
        }
        ...
        private sealed record MainText(
            ...
            Func<string, string> DataRestoreInvalidBackup,
            ...
            Func<bool, int, DateTimeOffset?, string> DataRestorePlan,
