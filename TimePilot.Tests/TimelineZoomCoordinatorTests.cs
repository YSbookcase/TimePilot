...
{
    public sealed class TimelineZoomCoordinatorTests
    {
        [Fact]
        public void Initialize_WiresZoomButtonActions()
        {
            ...
            try
            {
                ...
                var coordinator = new TimelineZoomCoordinator(
                    controls,
        ...
        [Fact]
        public void ApplyText_UpdatesZoomButtonLabels()
        {
            var controls = CreateControls();
            try
            {
                ...
                Assert.False(string.IsNullOrWhiteSpace(controls.ResetButton.Text));
            }
            finally
            {
                DisposeControls(controls);
